...
if ($ADMIN->fulltree) {
    ...
    $name = 'theme_unitec_corporate_grey/invert';
    $title = get_string('invert', 'theme_unitec_corporate_grey');
    $description = get_string('invertdesc', 'theme_unitec_corporate_grey');
